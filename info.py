...
BOT_TOKEN = environ.get('BOT_TOKEN', "7851835226:AAESZXrWrJ2oHczt8K3FCvzY-fmsm-uOsqA")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002342814494'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002314516275').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002439644741') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002438948729')).split()]  # For Multiple Id Use One Space Between Each.
...
STREAM_MODE = bool(environ.get('STREAM_MODE', Fale)) # Set True or False
